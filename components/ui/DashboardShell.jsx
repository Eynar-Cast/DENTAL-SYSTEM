...
export const NAV_ITEMS = [
  ...
  { href: "/dashboard/citas", label: "Agenda y citas", icon: "◷", roles: ["admin", "recepcionista"] },
  { href: "/dashboard/atenciones", label: "Atenciones", icon: "◆", roles: ["admin", "odontologo"] },
  { href: "/dashboard/procedimientos", label: "Tratamientos", icon: "✥", roles: ["admin", "recepcionista"] },
